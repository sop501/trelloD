...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'boards_key' => ['type' => 'index', 'columns' => ['board_id'], 'length' => []],
            'user_key' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'boards_key' => ['type' => 'foreign', 'columns' => ['board_id'], 'references' => ['boards', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public $records = [
        [
            ...
            'completed' => 1,
            'created' => '2016-11-26 13:22:47',
            'modified' => '2016-11-26 13:22:47'
        ],
    ];
}
